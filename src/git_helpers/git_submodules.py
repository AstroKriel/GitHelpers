...
def cmd_add_submodule(
    ...
    cmd_commit_submodule = [
        ...
        "commit",
        "-m",
        f"add {local_name} submodule",
    ]
    shell_interface.run_cmd(
        config=config,
        cmd=cmd_commit_submodule,
    )
