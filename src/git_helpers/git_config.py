...
def cmd_set_global_config(
    ...
    cmd_set_pull_rebase = ["git", "config", "--global", "pull.rebase", "false"]
    shell_interface.run_cmd(config=config, cmd=cmd_set_pull_rebase)
    ...
    cmd_set_pull_ff = ["git", "config", "--global", "pull.ff", "true"]
    shell_interface.run_cmd(config=config, cmd=cmd_set_pull_ff)
    cmd_set_merge_ff = ["git", "config", "--global", "merge.ff", "true"]
    shell_interface.run_cmd(config=config, cmd=cmd_set_merge_ff)
    ...
    cmd_set_rerere = ["git", "config", "--global", "rerere.enabled", "true"]
    shell_interface.run_cmd(config=config, cmd=cmd_set_rerere)
...
def show_global_config(
    ...
    def read_config_value(
        ...
        cmd_read_global_config = ["git", "config", "--global", "--get", key]
